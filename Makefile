...
default: check-deps clean build serve
...
# 	cat static/server.py > _site/server.py
...
build: static/favicon.ico static/ysap.png static/favicon.jpg
	...
	# copy static files
	cat static/logo.ico > _site/favicon.ico
	cat static/robots.txt > _site/robots.txt
	cat static/ysap.png > _site/static/ysap.png
	cat static/style.css > _site/static/style.css
	cat static/ansi.css > _site/static/ansi.css
	cat static/terminal.js > _site/static/terminal.js
	cat static/picture.png > _site/static/picture.png
	cat static/picture-square.png > _site/static/picture-square.png
	cat static/server.py > _site/server.py

	cat static/index.html > _site/index.html
	./make-commands-jsonp ./make-root/make-index > _site/static/commands.js
	./make-commands-jsonp ./make-r/make-index > _site/static/commands-r.js

	./make-root/make-index > _site/index.txt
	./make-r/make-index > _site/index-r.txt
